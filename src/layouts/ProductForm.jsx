...
const ProductForm = () => {
  ...
  const newProduct = useFormik({
    ...
    validationSchema: yup.object().shape({
      id: yup.number("Id phải là số").required("Không được bỏ trống"),
      name: yup
        .string("Tên sản phẩm phải là chữ")
        .required("Không được bỏ trống"),
      price: yup
        .number("Giá phải là số")
        .required("Không được bỏ trống"),
      img: yup
        .string("Link ảnh phải là chữ")
        .required("Không được bỏ trống"),
      description: yup
        .string("Description phải là chữ")
        .required("Không được bỏ trống"),
      type: yup
        .string("Type phải là chữ")
        .required("Không được bỏ trống"),
    }),
    onSubmit: (value) => {
      if (type === "create") {
